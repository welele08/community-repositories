...
SLOT="0"
IUSE=""
RDEPEND="!app-misc/sabayon-skel x11-themes/Humanity-Dark-Aqua-icon-theme"
...
src_install () {
	...
	cp -a  "${FILESDIR}"/4.0.97/img/button.svg "${D}"/usr/share/icons/Humanity-Dark-Aqua/apps/scalable/
